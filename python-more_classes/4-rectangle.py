...
4-cü task üçün eval() ilə yenidən yaratmağa imkan verən
__repr__ metodu əlavə edilmişdir.
"""
...
class Rectangle:
    ...
    def __str__(self):
        ...
        line = "#" * self.__width
        # Hündürlük qədər sətiri birləşdiririk
        return "\n".join([line for i in range(self.__height)])

    def __repr__(self):
        """
        Obyektin rəsmi simvol təsvirini qaytarır.
        Bu təsvir eval() ilə eyni instansiyanı yenidən yaratmaq üçün
